...
class DatabaseFactory:
    ...
    def create(database_type: Optional[str] = None, **kwargs) -> DatabaseInterface:
        ...
        Args:
            database_type: Type of database ('json', 'memory', or None for auto-detect)
    ...
    def _create_json(**kwargs) -> JSONAdapter:
        """Create JSON file-based adapter (for local demos with persistence)."""
