                        ...
                        {subfolders.map((folderPath) => {
                            ...
                            return (
                                <div
                                    ...
                                    className={cn(
                                        "relative group cursor-pointer rounded-lg border hover:border-slate-300 hover:shadow-md transition-all duration-200 overflow-hidden aspect-square flex flex-col bg-white",
                                        statusColor || "border-slate-200"
                                    )}
                                >
                                    {/* Folder Icon - Clickable to navigate */}
                                    <div
                                        onClick={() => setCurrentFolder(folderPath)}
                                        className="flex-1 p-3 flex flex-col items-center justify-center w-full relative"
                                    >
                                        <Folder className={cn("w-10 h-10 mb-2 transition-all duration-200 group-hover:scale-105", folderIconColor)} />
                                        ...
                                        {isUploading && folderProgress.completedCount !== undefined && folderProgress.totalCount !== undefined ? (
                                            <p className="mt-1 text-[10px] font-medium">
                                                <span className={cn(
                                                    ...
                                                    {folderProgress.completedCount}/{folderProgress.totalCount}
                                                </span>
                                            </p>
                                        ) : (
                                    ...
                                    {hoveredId === `folder-${folderPath}` && (
                                        <div className="absolute top-1.5 right-1.5 flex gap-1">
                                            <button
                                                ...
                                                className="p-1 bg-white/90 backdrop-blur-sm rounded hover:bg-red-50 transition-all duration-200 opacity-0 group-hover:opacity-100"
                                                title="Delete"
                                            >
                                    ...
                                    {isHovered && !isSelected && (
                                        <div className="absolute top-1.5 right-1.5 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                            <button
                                                ...
                                                className="p-1 bg-white/90 backdrop-blur-sm rounded hover:bg-blue-50 transition-all duration-200"
                                                title="Open"
                                            >
                                            ...
                                            <button
                                                ...
                                                className="p-1 bg-white/90 backdrop-blur-sm rounded hover:bg-red-50 transition-all duration-200"
                                                title="Delete"
                                            >
                                                <Trash2 className="w-3.5 h-3.5 text-red-600" />
                                            </button>
